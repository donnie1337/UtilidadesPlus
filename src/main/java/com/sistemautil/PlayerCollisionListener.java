...
import org.bukkit.event.entity.EntityCollideWithEntityEvent;
...
public final class PlayerCollisionListener implements Listener {
    ...
    @EventHandler(priority = EventPriority.HIGHEST, ignoreCancelled = true)
    public void onPlayerCollision(EntityCollideWithEntityEvent event) {
        Entity first = event.getEntity();
        Entity second = event.getOtherEntity();
